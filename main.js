...
if (window.innerWidth <= 600) {
  ...
  modalContent.innerHTML = '<h2>The Latent Library: <i>The Great Gatsby</i></h2><body>Each cube in the constellation represents a sentence in <i>The Great Gatsby</i> by F. Scott Fitzgerald. They are arranged by their latent embedding (reduced to three dimensions by SKLearn&apos;s TSNE algorithm) in the Google Universal Sentence Encoder. In effect, this means similar sentences are near each other. Use the arrow keys to move and the mouse to change the camera angle. Sentences in the crosshairs will be displayed here. Built by <a href="https://willallstetter.com" target="_blank">Will Allstetter</a>.</body>';
